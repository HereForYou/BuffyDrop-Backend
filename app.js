...
var express = require("./config/express"),
  ...
  http = require("http"),
  https = require("https"),
  path = require("path"), // Import path module for file paths
...
const desText1 =
  "🔥 Receive rewards based on your rank for joining the Buffy bot. But when will this process end? Did you wait to join the bot later to get more tokens?";
const midText1 = "No one knows ... 😈\n"; // Replace with your desired description
const cert1 =
  "Early users receive a much higher reward percentage for inviting others to the bot, so join quickly!\n\nClick to launch Buffy"; // Replace with your desired certificate text
...
mongoose().then(async () => {
  ...
  app.post("/api/user/joinTG/:id", (req, res) => {
    ...
    TGbot.getChatMember(groupId, USER_TEL_ID)
      .then(() => {
